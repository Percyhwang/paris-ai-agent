...
const HOME_COPY = {
  ko: {
    ...
    supportLoggedOutPrefix: "로그인하면 일정, 예산, 숙소/항공권 검색, 기록까지 이어서 관리할 수 있어요. ",
  ...
  en: {
    ...
    supportLoggedOutPrefix: "Sign in to keep your trip plan, budget, stay and flight searches, and diary connected. ",
